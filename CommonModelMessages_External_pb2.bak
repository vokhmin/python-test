...
_PROTOPAYLOADTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PING_REQ', index=3, number=52,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PING_RES', index=4, number=53,
      serialized_options=None,
      type=None),
  ],
